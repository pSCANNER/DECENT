...
public class InputPreprocessorTest extends InputPreprocessor{
	...
	public void testDatePad() {
		...
		Assert.assertEquals("03/03/2013", padDate("03/03/13", 14));
		Assert.assertEquals("03/03/1987", padDate("03/03/87", 99));
	...
	public void testInputFormat() throws ParseException {
		...
		Assert.assertEquals("06/07/1949", outDate.format(inDate2.parse(padDate(date1, 14))));
		Assert.assertEquals("12/05/2013", outDate.format(inDate2.parse(padDate(date2, 14))));
